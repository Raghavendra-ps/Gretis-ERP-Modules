...
scheduler_events = {
    "cron": {
        "0 0 1,16 * *": [
            "hrms.hrms.hr.doctype.fee_records.send_fee_records_email"
        ]
    }
}
...
scheduler_events = {
    "hourly": [
        "hrms.hr.doctype.smartoffice_attendance_logs.smartoffice_attendance_logs.update_employee_checkin"
    ],
}
