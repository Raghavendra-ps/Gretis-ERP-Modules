...
# In frappe/hooks.py
override_whitelisted_methods = {
    "frappe.integrations.doctype.employee_verification.api.get_employee_verification_details": 
    "frappe.integrations.doctype.employee_verification.api.get_employee_verification_details"
}

scheduler_events = {
    "daily": [
        "frappe.integrations.doctype.automatic_email_scheduler.automatic_email_scheduler.send_scheduled_emails"
    ]
}
