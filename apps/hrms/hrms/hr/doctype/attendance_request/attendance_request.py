...
from hrms.hr.utils import validate_active_employee  # Removed validate_dates import
...
class AttendanceRequest(Document):
    def validate(self):
        if frappe.session.user == 'dir@gretisindia.com':
            pass
        else:
            validate_active_employee(self.employee)
            # Removed date validation restriction, allow both past and future dates
            # validate_dates(self, self.from_date, self.to_date)  # Commented out
