(() => {
  // ../alerts/alerts/public/js/alerts.bundle.js
  var LevelUpCore = class {
    destroy() {
      for (let k in this) {
        if (this.$hasProp(k))
          delete this[k];
    ...
    $hasProp(k, o) {
      return Object.prototype.hasOwnProperty.call(o || this, k);
    }
    $is(v, t) {
      return v != null && this.$type(v) === t;
    }
    $of(v, t) {
      return typeof v === t;
    }
    $isObjLike(v) {
      return v != null && this.$of(v, "object");
    }
    $isStr(v) {
      return this.$is(v, "String");
    }
    $isStrVal(v) {
      return this.$isStr(v) && v.length;
    }
    $isNum(v) {
      return this.$is(v, "Number") && isFinite(v);
    }
    $isBool(v) {
      return v === true || v === false;
    }
    $isBoolLike(v) {
      return this.$isBool(v) || v === 0 || v === 1;
    }
    $isFunc(v) {
      return this.$of(v, "function") || /(Function|^Proxy)$/.test(this.$type(v));
    }
    $isArr(v) {
      return this.$is(v, "Array");
    }
    $isArrVal(v) {
      return this.$isArr(v) && v.length;
    }
    $isArgs(v) {
      return this.$is(v, "Arguments");
    }
    $isArgsVal(v) {
      return this.$isArgs(v) && v.length;
    }
    $isArrLike(v) {
      return this.$isObjLike(v) && !this.$isStr(v) && this.$isNum(v.length) && (v.length === 0 || v[v.length - 1] != null);
    }
    $isBaseObj(v) {
      return this.$is(v, "Object");
    }
    $isObj(v, d) {
      return this.$isObjLike(v) && (!(v = Object.getPrototypeOf(v)) || this.$hasProp("constructor", v) && this.$isFunc(v.constructor) && (!d || this.$fnStr(v.constructor) === this.$fnStr(Object)));
    }
    $fnStr(v) {
    ...
    $isDataObj(v) {
      return this.$isObj(v, 1);
    }
    $isDataObjVal(v) {
      return this.$isDataObj(v) && !this.$isEmptyObj(v);
    }
    $isEmpty(v) {
      return v == null || v === "" || v === 0 || v === false || this.$isArrLike(v) && v.length === 0 || this.$isEmptyObj(v);
    }
    $ext(v, o, s, e) {
      if (this.$isDataObj(v))
        for (let k in v)
          this.$getter(k, v[k], s, e, o);
      return this;
    }
    $def(v, o) {
      return this.$ext(v, o, 0);
    }
    $xdef(v, o) {
      return this.$ext(v, o, 0, 1);
    }
    $static(v, o) {
      return this.$ext(v, o, 1);
    }
    $getter(k, v, s, e, o) {
      o = o || this;
      if (!s)
        o[(k[0] !== "_" ? "_" : "") + k] = v;
      if (s || e && o[k] == null)
        Object.defineProperty(o, k, s ? { value: v } : { get() {
          return this["_" + k];
        } });
      return this;
    }
    $extend() {
      let a = this.$toArr(arguments), d = this.$isBool(a[0]) && a.shift(), v = this.$isBaseObj(a[0]) ? a.shift() : {};
      for (let i = 0, l = a.length; i < l; i++) {
        if (!this.$isBaseObj(a[i]))
          continue;
        for (let k in a[i]) {
          if (!this.$hasProp(k, a[i]) || a[i][k] == null)
            continue;
          if (!d || !this.$isBaseObj(v[k]) || !this.$isBaseObj(a[i][k]))
            v[k] = a[i][k];
          else
            this.$extend(d, v[k], a[i][k]);
        }
      }
      return v;
    }
    $toArr(v, s, e) {
      try {
        return Array.prototype.slice.call(v, s, e);
      } catch (_) {
        return [];
      }
    }
    ...
    $call(fn, a, o) {
      ...
      switch ((a || "").length) {
        case 0:
          return fn.call(o);
        case 1:
          return fn.call(o, a[0]);
        case 2:
          return fn.call(o, a[0], a[1]);
        case 3:
          return fn.call(o, a[0], a[1], a[2]);
        case 4:
          return fn.call(o, a[0], a[1], a[2], a[3]);
        case 5:
          return fn.call(o, a[0], a[1], a[2], a[3], a[4]);
        default:
          return fn.apply(o, a);
      }
    }
    ...
    $xtry(fn, a, o) {
      return this.$fn(function() {
        return this.$try(fn, a, o);
      });
    }
    $timeout(fn, tm, a) {
      if (tm == null)
        return fn && clearTimeout(fn) || this;
    ...
    $proxy(fn, tm) {
      ...
      return {
        ...
        delay: function() {
          this._fn(arguments, 1);
        },
        cancel: function() {
          this._r && (this._r = clearTimeout(this._r));
        }
      };
    }
    $hasElem(id) {
  ...
  var LevelUpBase = class extends LevelUpCore {
    ...
    debug(t, m) {
      return this._prod ? this : this.$alert(t, m, "gray");
    }
    log(t, m) {
      return this._prod ? this : this.$alert(t, m, "cyan");
    }
    info(t, m) {
      return this.$alert(t, m, "light-blue");
    }
    warn(t, m) {
      return this.$alert(t, m, "orange");
    }
    error(t, m) {
      return this.$alert(t, m, "red");
    }
    fatal(t, m) {
      return this.$alert(t, m, "red", 1);
    }
    $toast(m, i) {
    ...
    success_(m) {
      return this.$toast(m, "green");
    }
    info_(m) {
      return this.$toast(m, "blue");
    }
    warn_(m) {
      return this.$toast(m, "orange");
    }
    error_(m) {
      return this.$toast(m, "red");
    }
    $console(fn, a) {
      if (this._prod)
        return this;
      if (!this.$isStr(a[0]))
        Array.prototype.unshift.call(a, this._pfx);
      else
    ...
    ajax(u, o, s, f) {
      ...
      o = this.$extend(1, {
        ...
        error: this.$fn(function(r, t) {
          r = this.$isStrVal(r) && __(r) || this.$isStrVal(t) && __(t) || __("The ajax request sent raised an error.");
    ...
    request(m, a, s, f) {
      ...
      let d = {
        ...
        callback: this.$fn(function(r) {
          ...
          if (!this.$isDataObj(r) || !r.error)
            return s && s(r);
          r = this.$isDataObjVal(r) && (this.$isStrVal(r.message) && __(r.message) || this.$isStrVal(r.error) && __(r.error)) || __("The request sent returned an invalid response.");
          f ? f({ message: r }) : this.error(r);
        }),
        error: this.$fn(function(r, t) {
      ...
      if (!this.$isEmptyObj(a))
        this.$extend(d, { type: "POST", args: a });
      try {
        frappe.call(d);
      } catch (e) {
        f ? f(e) : this.error(e.message);
    ...
    xon(e, fn) {
      return this._on(e, fn, 0, 1);
    }
    once(e, fn) {
      return this._on(e, fn, 1);
    }
    xonce(e, fn) {
      return this._on(e, fn, 1, 1);
    }
    real(e, fn, n) {
      return this._on(e, fn, n, 0, 1);
    }
    xreal(e, fn, n) {
      return this._on(e, fn, n, 1, 1);
    }
    off(e, fn, rl) {
      if (e == null)
        return this._off();
      if (this.$isBoolLike(e))
        return this._off(0, 1);
      if (!this.$isStrVal(e))
        return this;
    ...
    emit(e) {
      let a = this.$toArr(arguments, 1), p = Promise.resolve();
      e = e.split(" ");
    ...
    _off(e, fn) {
      if (e && fn)
        ...
        for (let ev in this._events.list)
          fn ? this._off(ev, fn) : this._del(ev);
      } else {
        let es = this._events;
    ...
    _emit(e, a, p) {
      let ev = this._events.list[e].slice(), ret = [];
      p && p.catch(this.$fn(function(e2) {
        this._error("Events emit", e2, a, e2.message, e2.stack);
      }));
      for (let x = 0, i = 0, l = ev.length; i < l; i++) {
    ...
    stop_realtime() {
      ...
      for (let e in this._events.real)
        this._off(e);
      this.info_(__("Frappe realtime events is unavailable."));
    }
  };
  var LevelUp = class extends LevelUpBase {
    constructor(mod, key, doc, ns, prod) {
      ...
      this._win = {
        e: {
          ...
          popstate: this.$fn(function() {
            !this._win.c && this._win.fn.delay();
          }),
          change: this.$fn(function() {
            !this._win.c && this._win.fn.call(1);
          })
        },
        c: 0,
    ...
    _routes() {
      let v;
      try {
        this._router.obj && (v = !this._router.old ? frappe.get_route() : this._router.obj.parse());
      } catch (_) {
      }
      if (this.$isArrVal(v))
        this._router.val = v;
    ...
    route(i) {
      return this._router.val[i] || this._router.val[0];
    }
    get is_list() {
      return this.route(0).toLowerCase() === "list";
    }
    get is_form() {
      return this.route(0).toLowerCase() === "form";
    }
    get is_self() {
      return this._doc.test(this.route(1));
    }
    is_doctype(v) {
      return this.route(1) === v;
    }
    _is_self_view(o) {
      return this._doc.test(o && o.doctype || this.route(1));
    }
    get_list(o) {
      return (o = o || cur_list) && this.$isObjLike(o) ? o : null;
    }
    get_form(o) {
      return (o = o || cur_frm) && this.$isObjLike(o) ? o : null;
    }
    is_self_list(o) {
      return this.is_list && this._is_self_view(this.get_list(o));
    }
    setup_list(o) {
      if (!(o = this.get_list(o)) || !this.is_self_list(o))
        return this;
      ...
      if (this._is_enabled) {
        ...
        o.page.add_inner_message(__("{0} app is disabled.", [this._mod])).removeClass("text-muted").addClass("text-danger");
        o["_" + k] = o[k];
        o[k] = function() {
        };
    ...
    is_self_form(o) {
      return this.is_form && this._is_self_view(this.get_form(o));
    }
    clean_form(frm) {
      if (frm = this.get_form(frm)) {
        try {
          (!frm[this._tmp] || frm[this._tmp].disabled) && this.enable_form(frm);
        } finally {
    ...
    setup_form(frm, wf) {
      if (!(frm = this.get_form(frm)) || !this.is_self_form(frm))
        return this;
      frm[this._tmp] = { disabled: 0, intro: 0, workflow: 0, fields: [] };
      try {
        if (this._is_enabled)
          this.enable_form(frm, wf);
        else
          this.disable_form(frm, __("{0} app is disabled.", [this._mod]), wf);
      } catch (e) {
    ...
    enable_form(frm, wf) {
      ...
      try {
        ...
        if (obj && !obj.disabled || dfs && !dfs.length)
          return this;
        for (let i = 0, l = frm.fields.length, f; i < l; i++) {
          f = frm.fields[i];
          if (dfs && !dfs.includes(f.df.fieldname))
            continue;
          if (f.df.fieldtype === "Table")
            this._enable_table(frm, f.df.fieldname);
          else
            this._enable_field(frm, f.df.fieldname);
        }
        wf == null && obj && (wf = obj.workflow);
        if (!!frm.is_new() || !this._has_flow(frm, wf))
          frm.enable_save();
        else
          (!obj || (obj.workflow = 1)) && frm.page.show_actions_menu();
        if (obj && obj.intro)
          frm.set_intro() && (obj.intro = 0);
      } catch (e) {
        this._error("Enable form", e.message, e.stack);
      } finally {
        try {
          if (obj)
            this.$extend(obj, { disabled: 0, fields: [] });
        } catch (_) {
        }
      ...
      try {
        ...
        for (let i = 0, l = frm.fields.length, f; i < l; i++) {
          ...
          if (f.fieldtype === "Table")
            this._disable_table(frm, f.fieldname);
          else
            this._disable_field(frm, f.fieldname);
        }
        wf == null && obj && (wf = obj.workflow);
        if (!!frm.is_new() || !this._has_flow(frm, wf))
          frm.disable_save();
        else
          (!obj || (obj.workflow = 1)) && frm.page.hide_actions_menu();
      } catch (e) {
    ...
    _has_flow(frm, wf) {
      try {
        return frm && wf && frm.states && frm.states.get_state();
      } catch (_) {
      }
    }
    ...
    _toggle_translatable(f, s) {
      if (!f.df || !cint(f.df.translatable) || !f.$wrapper)
        return;
    ...
    _enable_field(frm, k, n, ck) {
      try {
        let o = this.is_self_form(frm) && frm[this._tmp], fk = ck == null ? n == null ? k : [k, n].join("-") : [k, n, ck].join("-");
        if (o && !o.fields.includes(fk))
          return;
        let f = this._get_field(frm, k, n, ck);
        if (!f || !f.df || !!cint(f.df.hidden) || !this._is_field(f.df.fieldtype))
          return;
        o && (fk = o.fields.indexOf(fk)) >= 0 && o.fields.splice(fk, 1);
        n == null && frm.set_df_property(k, "read_only", 0);
        if (n == null)
          return this._toggle_translatable(f, 1);
        if (ck == null)
          return f.grid && f.grid.toggle_enable(n, 1);
    ...
    _disable_field(frm, k, n, ck) {
      try {
        let fs = this.is_self_form(frm) && frm[this._tmp].fields, fk = ck == null ? n == null ? k : [k, n].join("-") : [k, n, ck].join("-");
        if (fs && fs.includes(fk))
          return;
        let f = this._get_field(frm, k, n, ck);
        if (!f || !f.df || !!cint(f.df.hidden) || !this._is_field(f.df.fieldtype))
          return;
        ...
        if (n == null)
          return this._toggle_translatable(f, 0);
        if (ck == null)
          return f.grid && f.grid.toggle_enable(n, 0);
        f = this._get_field(frm, k, n);
    ...
    _is_field(v) {
      return v && !/^((Tab|Section|Column) Break|Table)$/.test(v);
    }
    ...
    _enable_table(frm, k) {
      try {
        ...
        let f = frm.get_field(k);
        if (!f || !f.df || !!cint(f.df.hidden) || f.df.fieldtype !== "Table" || !f.grid)
          return;
    ...
    _disable_table(frm, k, o) {
      try {
        let fs = this.is_self_form(frm) && (frm[this._tmp] || {}).fields, f = frm.get_field(k);
        if (!f || !f.df || !!cint(f.df.hidden) || f.df.fieldtype !== "Table" || !f.grid)
          return;
        ...
        if (!o || !o.edit) {
          ...
          if (this.$isArrVal(f.docfields))
            ds.push(f.docfields);
          for (let i = 0, l = ds.length; i < l; i++) {
            for (let x2 = 0, z = ds[i].length, d; x2 < z; x2++)
              (d = ds[i][x2]) && !d.read_only && (!o || !(o.keep || "").includes(d.fieldname)) && (d.read_only = 1) && f.of.read.push(d.fieldname);
          }
        }
        this._reload_field(frm, k);
    ...
    _set_field_desc(f, m) {
      ...
      if (m && f.set_new_description)
        c++ && f.set_new_description(m);
  ...
  var Alerts = class extends LevelUp {
    constructor() {
      ...
      this._seen_retry = 0;
      this._mock = null;
      this.real("use_realtime", function() {
        this.$timeout(this._realtime_tm);
      }, 1);
      this._realtime_tm = this.$timeout(this.stop_realtime, 6e4);
      this.$timeout(function() {
        delete this._realtime_tm;
      }, 65e3);
    ...
    show() {
      return this.has_alerts ? this._render() : this;
    }
    setup_list() {
      if (!this._is_enabled)
    ...
    _setup(ret) {
      ...
      }).xreal("app_status_changed", function(ret2) {
        this._debug("real app_status_changed", ret2);
      ...
      }).xreal("type_changed", function(ret2) {
        this._debug("real type_changed", ret2);
        if (!this.$isDataObjVal(ret2))
          return;
        var name = cstr(ret2.name);
        if (cstr(ret2.action) === "trash")
          delete this._styles[name];
        else {
          if (!this._styles[name])
            this._styles[name] = new AlertsStyle(this._id, this._slug(name));
          this._styles[name].build(ret2.background, ret2.border_color, ret2.title_color, ret2.content_color, ret2.dark_background, ret2.dark_border_color, ret2.dark_title_color, ret2.dark_content_color);
        }
      }).xreal("show_alert", function(ret2) {
        this._debug("real show_alert", ret2);
        if (this._is_enabled && this._is_valid(ret2))
          this._queue(ret2);
      });
      this.emit("ready");
      if (this._is_enabled) {
    ...
    _get_alerts() {
      if (this._in_req)
        return;
      this._in_req = 1;
      this.request("user_alerts", this._first ? { init: 1 } : null, function(ret) {
        this._first = 0;
        this._in_req = 0;
        ...
        if (!this.$isDataObjVal(ret))
          ...
          if (this._is_enabled) {
            if (this.$isArrVal(ret.types))
              this._build_types(ret.types);
            if (this.$isArrVal(ret.alerts))
              this._queue(ret.alerts);
          }
        }
      }, function(e) {
        this._first = 0;
    ...
    _is_valid(data) {
      if (!this.$isDataObjVal(data))
        return false;
      if (this._seen.includes(data.name))
        return false;
      var user = frappe.session.user, score = 0;
      if (this.$isArrVal(data.users) && data.users.includes(user))
        score++;
      if (!score && this.$isArrVal(data.roles) && frappe.user.has_role(data.roles))
        score++;
      if (!score)
        return false;
      if (this.$isArrVal(data.seen_today) && data.seen_today.includes(user))
        return false;
      var seen_by = this.$isDataObj(data.seen_by) ? data.seen_by : {}, seen = seen_by[user] != null ? cint(seen_by[user]) : -1;
      if (cint(data.is_repeatable) < 1 && seen > 0)
        return false;
      if (seen >= cint(data.number_of_repeats))
        return false;
      return true;
    }
    _queue(data) {
    ...
    _render_dialog() {
      ...
      this._dialog.setName(data.name).setTitle(data.title).setMessage(data.message).setTimeout(data.display_timeout).setSound(data.display_sound, data.custom_display_sound).onShow(this.$fn(function() {
        this._seen.push(this._dialog.name);
      })).onHide(this.$fn(this._render), 200).render(this._slug(data.alert_type)).show();
    }
    _mmark_seens() {
      var seen = this._seen.splice(0, this._seen.length);
      this.request("mark_seens", { names: seen }, function(ret) {
        if (!this.$isDataObjVal(ret)) {
    ...
    _retry_mark_seens() {
      if (!this._seen_retry) {
        this._seen_retry++;
        this.$timeout(this._mmark_seens, 2e3);
      } else {
        this._seen_retry = 0;
    ...
    _build_types(data) {
      ...
      for (var i = 0, l = data.length; i < l; i++)
        this._styles[data[i].name] = new AlertsStyle(this._id, this._slug(data[i].name)).build(data[i].background, data[i].border_color, data[i].title_color, data[i].content_color, data[i].dark_background, data[i].dark_border_color, data[i].dark_title_color, data[i].dark_content_color);
    }
    _destroy_types() {
      for (var k in this._styles) {
        try {
          this._styles[k].destroy();
        } catch (_) {
        }
  ...
  var AlertsMock = class extends LevelUpCore {
    constructor() {
      super();
    ...
    build(data) {
      ...
      this._dialog.setTitle("Mock Alert").setMessage(data.message || "This is a mock alert message.");
      ...
      if (data.alert_type)
        ...
        this._dialog.setStyle(data.background, data.border_color, data.title_color, data.content_color, data.dark_background, data.dark_border_color, data.dark_title_color, data.dark_content_color).render();
      this._dialog.show();
      return this;
    }
    show() {
  ...
  var AlertsDialog = class extends LevelUpCore {
    ...
    setStyle(background, border, title, content, dark_background, dark_border, dark_title, dark_content) {
      if (!this._style)
        this._style = new AlertsStyle(this._id, this._class);
      this._style.build(background, border, title, content, dark_background, dark_border, dark_title, dark_content);
      return this;
    }
    setTimeout(sec) {
      if (this.$isNum(sec) && sec > 0)
        this._timeout = sec * 1e3;
      return this;
    }
    setSound(file, fallback) {
      this.stopSound();
      this._sound.loaded = 0;
      if (!this.$isStrVal(file) || file === "None")
        return this;
      if (file === "Custom")
        file = fallback;
      else
        file = "/assets/frappe/sounds/" + file.toLowerCase() + ".mp3";
      if (!this.$isStrVal(file))
        return this;
      if (!this.$sound) {
      ...
      this.$sound.attr("src", file).off("canplaythrough").on("canplaythrough", this.$fn(function() {
    ...
    onShow(fn, delay) {
      if (this.$isFunc(fn)) {
        if (!this.$isNum(delay) || delay < 1)
          this._on_show = this.$fn(fn);
        else
          this._on_show = this.$fn(function() {
    ...
    onHide(fn, delay) {
      if (this.$isFunc(fn)) {
        if (!this.$isNum(delay) || delay < 1)
          this._on_hide = this.$fn(fn);
        else
          this._on_hide = this.$fn(function() {
            this.$timeout(fn, delay);
          });
      }
      return this;
    ...
    render(clss) {
      ...
      if (!clss && this._class !== this._def_class)
        clss = this._def_class;
      if (clss) {
        this._class = clss;
        this._container.attr("id", this._class);
      }
      ...
      if (this._on_hide)
        this._dialog.onhide = this._on_hide;
      if (this._on_show)
        this._dialog.on_page_show = this._on_show;
      return this;
    }
    show() {
      if (!this._dialog)
    ...
    stopSound() {
      if (this._sound.timeout)
        this.$timeout(this._sound.timeout);
  ...
  var AlertsStyle = class extends LevelUpCore {
    constructor(id, _class) {
      super();
      this._id = "style-" + id;
      this._class = _class;
    ...
    build(background, border, title, content, dark_background, dark_border, dark_title, dark_content) {
      var css = [], tpl = [
        "$0{background:$1 !important}",
        "$0,$0>.modal-header,$0>.modal-footer{border:1px solid $1 !important}",
        "$0>$1>$2>.modal-title{color:$3 !important}$0>$1>$2>.indicator::before{background:$3 !important}$0>$1>.modal-actions>.btn{color:$3 !important}",
      ...
      if (this.$isStrVal(title))
        css.push(tpl[2].replace(rgx[1], ".modal-header").replace(rgx[2], ".title-section").replace(rgx[3], title));
      ...
      if (this.$isStrVal(dark_title))
        css.push(tpl[2].replace(rgx[0], "$t $0").replace(rgx[1], ".modal-header").replace(rgx[2], ".title-section").replace(rgx[3], dark_title));
      if (this.$isStrVal(dark_content))
        css.push(tpl[3].replace(rgx[0], "$t $0").replace(rgx[1], ".modal-body").replace(rgx[2], dark_content));
      if (css.length) {
        var sel = "#" + this._class + ">.modal-content";
        css = css.join("\n").replace(rgx[0], sel).replace(rgx[4], '[data-theme="dark"]');
        if (this._dom.styleSheet)
          this._dom.styleSheet.cssText = css;
        else {
  ...
  $(document).ready(function() {
    ...
    let app = new LevelUpCore(), id = "core-polyfill";
    function $onload() {
      ...
      Promise.prototype.timeout = function(ms) {
        return Promise.race([this, Promise.wait(ms).then(function() {
          throw new Error("Time out");
        })]);
      };
    }
    if (app.$isFunc(Promise) && app.$isFunc(id.trim) && app.$isFunc(id.includes) && app.$isFunc(id.startsWith) && app.$isFunc(id.endsWith) && app.$isFunc([].includes) && app.$isFunc(app.$isFunc.bind))
      $onload();
    else if (app.$hasElem(id))
      $onload();
    else
      app.$loadJs("https://polyfill.io/v3/polyfill.min.js?features=String.prototype.trim%2CString.prototype.includes%2CString.prototype.startsWith%2CString.prototype.endsWith%2CArray.prototype.includes%2CFunction.prototype.bind%2CPromise", { id, onload: $onload });
    $.fn.hidden = function(s) {
      return this.toggleClass("lu-hidden", !!s);
    };
    $.fn.isHidden = function() {
      return this.hasClass("lu-hidden");
    };
    !app.$hasElem("lu-style") && app.$load(".lu-hidden { display: none; }", { id: "lu-style" });
    frappe.alerts = new Alerts();
  });
})();
//# sourceMappingURL=alerts.bundle.3IZ6NCYD.js.map
